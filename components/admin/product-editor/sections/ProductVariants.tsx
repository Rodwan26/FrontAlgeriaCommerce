...
export default function ProductVariants({
  ...
  function getColorHex(optionName: string, valueName: string) {
      ...
      <div className="border-b border-gray-200 px-5 py-4">
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-xs text-gray-500">
              Manage price, SKU, inventory, and other details for each
              product variant.
            </p>
          </div>
              ...
              >
                ...
                <td className="px-5 py-4">
                  <input
                    ...
                    placeholder="SKU"
                    className="w-32 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
                  />
                </td>
